const buttons = document.querySelectorAll('.main-bottom-button');
...
buttons.forEach(btn => {
  ...
  svg.attr('class', 'main-bottom-svg');
  const color1 = '#FFFFFF';
  const gradient = 'L(0, 0, 300, 300)#dcbab9-#D2A3A2';
